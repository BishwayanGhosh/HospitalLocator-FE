...
const LocateNearestHospitalMyLoc = () => {
  ...
  //this function receives latitude and longitude of a place as params, and set the response using setAddress() setter function. Hint: You may use 3rd Party API geocode.maps.co in this function
          ...
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead sx={{ fontSize: 34, fontWeight: 300, color: "black" }}>
                <TableRow>
                  <TableCell sx={{ fontSize: 14, color: "black" }}>
                    Hospital Name
                  </TableCell>
                  <TableCell sx={{ fontSize: 14, color: "black" }}>
                    Distance
